...
if wiki_entity:
    entity_id = wiki_entity.split("/")[-1]  # Отримуємо 'Q635041'

    # Використовуємо універсальний сервіс міток Wikidata
    sparql_query = f"""
...
plt.subplots_adjust(left=0.05, right=0.95, top=0.95, bottom=0.05)  # Замість tight_layout()
